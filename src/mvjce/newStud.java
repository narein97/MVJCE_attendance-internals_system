...
public class newStud extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tf2, javax.swing.GroupLayout.DEFAULT_SIZE, 279, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        intAttend ia=new intAttend();intAttend.l1.setText(dept);
        ia.setVisible(true);this.setVisible(false);
    }//GEN-LAST:event_jButton3ActionPerformed
    static String dept;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if((tf1.getText()).equals("") || (tf2.getText()).equals("") || (tf3.getText()).equals("")){
        JOptionPane.showMessageDialog(this, "Complete details have not been provided. Please try again.");
        }
        else{
        Database db = new Database();
        db.name=tf2.getText();db.section=tf3.getText();db.sem=Integer.toString(cb1.getSelectedIndex()+1);
        db.course=jTextField1.getText();
        System.out.println(db.name);System.out.println(db.section);System.out.println(db.sem);System.out.println(db.course);
